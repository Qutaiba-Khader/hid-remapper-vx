...
// A mapping: { id, inputs:[code,…], output, layers:[bool×4], sticky, tap, hold, scale, tint }
function mk(inputs, output, opts = {}) {
  return {
    ...
    layers: opts.layers || [true, false, false, false],
    sticky: !!opts.sticky,
    tap: !!opts.tap,
    hold: !!opts.hold,
...
window.HRX_STATE = { APP, ROW_TINTS, tintById, mk, uid };
