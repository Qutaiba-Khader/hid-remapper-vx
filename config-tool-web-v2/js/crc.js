/*
 * crc.js — IEEE 802.3 CRC-32, ported verbatim from config-tool-web/crc.js.
 * The working tool exports it as an ES module (`export default`); the new tool is
 * plain-script globals, so this exposes `window.HRX_CRC32` (and module.exports for Node tests).
 *
 * crc32(view, length): view is a DataView (or anything with .getUint8(n)); length in bytes.
 */
(function () {
  const crc_table = [
  ...
  if (typeof window !== "undefined") window.HRX_CRC32 = crc32;
  if (typeof module !== "undefined" && module.exports) module.exports = crc32;
})();
